...
import { getCookie, removeCookie, setCookie, setSourceCookie } from 'helpers/cookies'
  ...
  return (
    <>
      <div
        ...
        onClick={() => {
          // @ts-ignore
          setCookie('pref_job_title_id', function_job_title_id)
          if (cardType === 'hotjobs') {
            setCookie('reco_from', 'aws_hot_jobs')
          } else {
            removeCookie('reco_from')
          }
