...
function MouseOverPopover(props) {
    ...
    return (react_1["default"].createElement(react_1["default"].Fragment, null,
        react_1["default"].createElement("div", {
            className: classnames_1["default"](index_module_scss_1["default"].overview_item_value, (_a = {},
                _a[props.className] = !!props.className,
                _a)), "aria-owns": open ? 'mouse-over-popover' : undefined, "aria-haspopup": "true", onMouseEnter: handlePopoverOpen, onMouseLeave: handlePopoverClose, ref: ref
        }, is_url ?
