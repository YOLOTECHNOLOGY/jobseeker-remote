...
export default (props) => {
    return <div className={styles.container}> process.env.HOST_PATH: {process.env.HOST_PATH} process.env.NEXT_PUBLIC_HOST_PATH: {process.env.NEXT_PUBLIC_HOST_PATH} <Main {...props} /></div>
}