        ...
        <div className={style.search_input_layout}>
          ...
          <label htmlFor='input-search' className={style.job_search_container}>
            <Image
              ...
              src={require('./search.svg').default.src}
              alt='_'
            />
            <input
              id={'input-search'}
  ...
  return (
    <div className={style.search_card}>
      <div className={style.search_title_layout}>
        ...
        >
          {props.is_urgent && <span className={style.urgentLabel}>Urgent</span>}
          <span>{props.job_title}</span>
        </Link>
        {
          <div className={style.jobcard_salary_wrapper}>
            <div className={style.salary}>{props.local_salary_range_value}</div>
